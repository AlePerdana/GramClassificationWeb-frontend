...
import { 
  AreaChart, // Ganti BarChart jadi AreaChart
  Area,      // Ganti Bar jadi Area
  XAxis, 
  YAxis, 
  CartesianGrid, 
  Tooltip, 
...
// --- DATA DUMMY (Struktur sama, hanya visualisasi yang berubah) ---
const dataHariIni = [
...
const waitingQueue = [
  { id: 'P-001', name: 'Budi Santoso', time: '08:30', status: 'Menunggu Sampel' },
  { id: 'P-005', name: 'Siti Aminah', time: '09:15', status: 'Menunggu Sampel' },
  { id: 'P-008', name: 'Rudi Hartono', time: '10:00', status: 'Menunggu Sampel' },
  { id: 'P-012', name: 'Dewi Sartika', time: '10:45', status: 'Menunggu Sampel' },
];

const StatCard = ({ title, value, subtext, icon: Icon, imageSrc, color, bg }) => (
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* KIRI: Grafik Tren Produktivitas (Area Chart) */}
            ...
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={getChartData()} margin={{ top: 10, right: 0, left: -20, bottom: 0 }}>
                ...
                <Area 
                  ...
                  stroke="#94a3b8" 
                  strokeWidth={2}
                  strokeDasharray="4 4" // Garis putus-putus untuk target
                  fillOpacity={1} 
                  fill="url(#colorMasuk)" 
                />
                
                {/* Area Biru = Realisasi/Selesai */}
                <Area 
                  type="monotone" 
                  dataKey="selesai" 
                  name="Selesai" 
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col">
            ...
            {waitingQueue.map((patient) => (
              <div key={patient.id} className="p-4 border border-gray-100 rounded-xl hover:border-blue-200 hover:shadow-md transition-all group bg-white">
                ...
                <div className="mt-4 flex items-center justify-between">
                    ...
                    <button 
                      onClick={() => handleInputSample(patient.id)}
          ...
          <div className="mt-4 pt-4 border-t border-gray-50 text-center">
            <p className="text-xs text-gray-400">
                Data disinkronkan dari Admin pendaftaran.
            </p>
          </div>
        </div>
